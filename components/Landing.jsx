        ...
        <div id="home" className="bg-[#E0F8F2] relative min-h-screen flex">
            <div className="bg-transparent min-w-[50%] min-h-[#100vh/2] flex flex-col items-baseline justify-center pl-[3vw]">
                ...
                <div className="flex mt-8 justify-stretch w-3/4">
                    <button className="px-10 py-4 bg-[#FF6D2C] text-white text-[14px] font-inter border-2 border-black border-b-[5px] border-r-[5px] rounded-[13px]">
                        EXPLORE MORE
                    </button>
                    <div className="pl-12 flex flex-col justify-center items-baseline">
