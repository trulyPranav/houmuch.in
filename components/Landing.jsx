    ...
    return (
        <div id="home" className="bg-black/[0.92] relative min-h-screen flex flex-col xl:flex-row justify-center xl:justify-normal">
            <div className="bg-transparent min-w-[50%] min-h-[#100vh/2] flex flex-col items-baseline justify-center pl-[3vw]">
                <p className="text-white text-3xl xl:text-5xl font-[700] font-inter xl:leading-snug pl-2 xl:pl-0">Hotels & House Boats</p>
                <p className="text-[#FF3B30] text-4xl xl:text-6xl font-[400] font-courgette xl:leading-snug pl-2 xl:pl-0">guarenteed</p>
                <p className="text-white text-3xl xl:text-5xl font-[700] font-inter xl:leading-snug pl-2 xl:pl-0">at lowest rates!</p>
                <p className="text-white text-3xl xl:text-5xl font-[700] font-inter xl:leading-snug pl-2 xl:pl-0">Download Now!!</p>
